...
from models.MKHANet import build_net
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='MKHANet', type=str)
    parser.add_argument('--data_dir', type=str, default='')
    parser.add_argument('--data', type=str, default='Indoor')
    ...
    args.model_save_dir = os.path.join('results/', args.model_name, args.data, 'Training-Results/',args.times)
    ...
    os.system(command)
    command = 'cp ' + 'models/MKHANet.py ' + args.model_save_dir
    os.system(command)
